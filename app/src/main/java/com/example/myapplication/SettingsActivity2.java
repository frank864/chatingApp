...
public class SettingsActivity2 extends AppCompatActivity {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                        if ((datasnapshot.exists() && (datasnapshot.hasChild("name") && (datasnapshot.hasChild("image"))))) {
                            ...
                            Toast.makeText(SettingsActivity2.this, "Please set and update your profile information", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void sendUserToMainActivityActivity () {
            Intent mainintent = new Intent(SettingsActivity2.this, MainActivity.class);
